...
class Command(BaseCommand):
    ...
    def clear_existing_data(self):
        ...
        # Clear CSV users (they will be recreated)
        from django.contrib.auth.models import User
        csv_users = User.objects.filter(username__startswith='csv_user_')
        csv_user_count = csv_users.count()
        csv_users.delete()
        self.stdout.write(f'Cleared {csv_user_count} CSV users')
